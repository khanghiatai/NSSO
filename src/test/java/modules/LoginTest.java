...
public class LoginTest {
    ...
    private void login003_UpdateInfo(String fName, String lName, int status, int gender, String day, String month, String year, String text) {
        // get current time
        ...
        if (strTitle.equalsIgnoreCase(sResource.getResource("infobasic"))) {
            login.updateUserInfo(driver, fName + time, lName + time, status, gender, day, month, year, text + time);
    ...
    public Object[][] listUserAccount() {
        return new Object[][]{
                ...
                new Object[]{"khanghiatai@gmail.com", "@@123"},
        };
    }
    ...
    public Object[][] listUserInfo() {
        return new Object[][]{
                new Object[]{"firstName 1", "lastName 1", 2, 0, "1", "2", "1990", "text area 1"},
                new Object[]{"firstName 2", "lastName 2", 3, 1, "5", "6", "1992", "text area 2"},
                new Object[]{"firstName 3", "lastName 3", 5, 2, "7", "9", "1995", "text area 2"},
        };
    }
